...
<div class="stunning-header stunning-header-bg-lightviolet">
    <div class="stunning-header-content">
        <h1 class="stunning-header-title">{{$post->Post_title}}</h1>
    </div>
</div>
                    ...
                    <div class="post__content">
                        ...
                        <div class="post-additional-info">
                            ...
                            <span class="category">
                                ...
                                <a href="{{ route('category.single', ['id' => $post->category->id])}}">{{$post->category->category_name}}</a>
            ...
            <!-- End Sidebar-->
                ...
                <div class="blog-details-author">
                    ...
                    <div class="blog-details-author-thumb">
                        <img src="{{ asset($post->user->profile->avatar) }}" alt="Author" style="height: 80px; width:80px; ">
                    </div>
                ...
                <div class="pagination-arrow">
                    ...
                    <a href="{{ route('post.single', ['slug' => $prev_post->slug])}}" class="btn-next-wrap">
                        <div class="btn-content">
                            ...
                            <p class="btn-content-subtitle">{{$prev_post->Post_title}}</p>
                        </div>
                        <svg class="btn-next">
                    ...
                    <a href="{{ route('post.single', ['slug' => $next_post->slug])}}" class="btn-prev-wrap">
                        ...
                        <div class="btn-content">
                            ...
                            <p class="btn-content-subtitle">{{$next_post->Post_title}}</p>
                        </div>
                    </a>
                    @endif
